...
export default async function DossierDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      {/* Bannière statut */}
      <div className={`mb-6 p-3 rounded-xl text-sm flex items-center gap-2 ${dossier.statut === "BROUILLON" ? "bg-gray-50 text-gray-600 border border-gray-200" :
      ...
      <Card className="col-span-2 md:col-span-1 drop-shadow-xl shadow-indigo-200 ring-1 ring-blue-100 overflow-hidden">
        ...
        <CardContent className="space-y-3">
          ...
          <Link href={`/dashboard/dossier/${id}/paiement`} className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors group border border-gray-100">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium flex-shrink-0 ${paye ? "bg-green-100 text-green-700" :
